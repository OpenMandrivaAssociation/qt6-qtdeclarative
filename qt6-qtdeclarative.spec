...
%{_qtdir}/lib/metatypes/qt%{major}qmlqtimeexampleplugin_relwithdebinfo_metatypes.json
%{_qtdir}/lib/metatypes/qt%{major}qmltextballoonplugin_relwithdebinfo_metatypes.json
